...
from origuide.geometry.generic_tools import same_direction_vec
from origuide.geometry.geometry_models import Vertex, Edge, EDGE_UNKNOWN, Face, EDGE_VALLEY, EDGE_MOUNTAIN, angle_from_assignment
