...
The word itself if formed of two parts - \textit{ori} meaning folding, and \textit{kami} meaning paper. 
The earliest Japanese origami are dated back to the 6th century when the Buddhist monks introduced paper to Japan. \cite{wiki:history-of-origami}
It is also known that the paper figures were used in China as early as the 10th century for the religious purposes. \cite{wiki:origami}
From China and Japan, the art of paper folding spread all around the world.
